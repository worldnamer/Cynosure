...
/*
 * Copyright 2002-2008 the original author or authors. Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * environments, but also usable for standalone applications.
 * <p>
 * This class is not intended for direct usage by applications, although it can be used for example to override
 * JndiTemplate's <code>createInitialContext</code> method in unit tests. Typically, SimpleNamingContextBuilder will be
 * used to set up a JVM-level JNDI environment.
 * 
 * @author Rod Johnson
	...
	public Object lookup(String lookupName) throws NameNotFoundException
	{
		...
		if (found == null)
		{
			...
			throw new NameNotFoundException("Name [" + this.root + lookupName + "] not bound; " +
				this.boundObjects.size() + " bindings: [" + this.boundObjects.keySet() + "]");
		}
		return found;
	}
